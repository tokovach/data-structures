...
public class IndirectGraph<L, V> implements Graph<L, V> {
	...
	public boolean addEdge(L startingVertexLabel, L targetVertexLabel) {
		...
		return edges.get(startingVertexLabel).add(targetVertexLabel) && edges.get(targetVertexLabel)
						.add(startingVertexLabel);
	}
